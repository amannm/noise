...
```objc
func modelDescription(ofFunctionNamed functionName: String, completionHandler handler: @escaping (MLModelDescription?, (any Error)?) -> Void)
```
...
- [modelDescription(completionHandler:)](modeldescription(completionhandler:).md)
